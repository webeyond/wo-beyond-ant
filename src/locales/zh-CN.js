export default {
  ...
  'menu.home': '首页',
  'menu.workers': '后台管理',
  'menu.workers.workerinfo': '地推专员管理',
  'menu.orders': '订单',
  'menu.orders.orderdetail': '订单详情',
  'menu.dashboard': '展示台',
  'menu.dashboard.analysis': '划小营销监控大屏',
  'menu.dashboard.monitor': '监控页',
  'menu.dashboard.workplace': '工作台',
  'menu.before': '划小营销前评估',
  'menu.before.funnel': '漏斗分析',
  'menu.before.potentiallist': '潜在客户列表',
  'menu.before.potentialdetail': '潜在客户详情',
  'menu.after': '划小营销后评价',
  'menu.after.countmap': '网格地图销售分析',
  'menu.after.salesbytime': '时间环比销售分析',
  'menu.after.topsales': '热门分析',
  'menu.after.quota': '指标仪表盘',
